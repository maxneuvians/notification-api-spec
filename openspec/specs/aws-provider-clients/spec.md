# Capability: aws-provider-clients

AWS-backed provider client behaviors for SMS and email delivery, including request normalization, MIME construction, error mapping, and interface compatibility.
