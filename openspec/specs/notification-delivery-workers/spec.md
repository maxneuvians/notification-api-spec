# Capability: notification-delivery-workers

Queue-backed notification persistence and delivery workers for SMS and email, including throttling, retry behavior, callbacks, and worker lifecycle management.
